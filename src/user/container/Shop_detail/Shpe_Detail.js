...
function Shpe_Detail(props) {

    const [fruitedetalis , setFruitedetails] = useState({})
    console.log(fruitedetalis);
    ...
    const getData = async() => {
        ...
        try {
            ...
            let fdata = data.find((v) => v.id === id)
            setFruitedetails(fdata)
                            ...
                            <div className="row g-4">
                                <div className="col-lg-6">
                                    <div className="border rounded">
                                        <a href="#">
                                            <img src={`../${fruitedetalis.image}`} className="img-fluid rounded" alt="Image" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <h4 className="fw-bold mb-3">{fruitedetalis.name}</h4>
                                    <p className="mb-3">Category: Vegetables</p>
                                    <h5 className="fw-bold mb-3">{fruitedetalis.price} $</h5>
